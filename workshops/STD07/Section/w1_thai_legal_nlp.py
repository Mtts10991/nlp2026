...
DATA_PATH = (
    os.path.join(BASE_DIR, 'data', 'processed', 'thai_ip_dataset.json')
    if os.path.isdir(os.path.join(BASE_DIR, 'data'))
    else os.path.join(_parent, 'Section', 'data', 'processed', 'thai_ip_dataset.json')
)
    ...
    def tokenize(self, text: str, remove_stopwords: bool = False) -> List[str]:
        ...
        for i, compound in enumerate(self.compounds):
            if compound in protected:
                ...
                protected = protected.replace(compound, f" {ph} ")
