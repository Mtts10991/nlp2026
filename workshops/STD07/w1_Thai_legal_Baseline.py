...
# tokens = คือการใช้ legal_tokenizer เพื่อแยกคำในข้อความ sample_text ออกมาเป็นรายการของคำ (tokens) ที่ถูกต้องตามกฎหมาย
# ในการแยกข้อความแบบนี้ AI LLM อื่นเช่น gpt ก็ทำแบบนี้ได้ แต่จะมีความกำกวมมากกว่า เพราะไม่ได้ใช้ tokenizer ที่ออกแบบมาเฉพาะสำหรับภาษาไทยและบริบททางกฎหมาย
# สรุป token คือ การแยกคำในข้อความ sample_text ออกมาเป็นรายการของคำที่ถูกต้องตามกฎหมาย โดยใช้ legal_tokenizer ซึ่งเป็นเครื่องมือที่ออกแบบมาเฉพาะสำหรับภาษาไทยและบริบททางกฎหมาย เพื่อให้ได้ผลลัพธ์ที่แม่นยำและลดความกำกวมในการวิเคราะห์ข้อความทางกฎหมาย
tokens = legal_tokenizer(sample_text)
print(f"Original Text: {sample_text}")
print(f"Tokens: {tokens}")
